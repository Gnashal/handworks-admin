  ...
  return (
    <button
      className={`flex items-center gap-3 px-4 py-3 rounded-xl w-full text-left transition ${
        active ? 'bg-gray-100 text-gray-900 font-semibold' : 'text-gray-600 hover:bg-gray-50'
      }`}
    >
...
const Sidebar: React.FC = () => {
  return (
    <aside className="w-72 flex-shrink-0 bg-white border-r border-gray-100 p-6 flex flex-col">
      {/* Logo + Title */}
      <div className="mb-8">
