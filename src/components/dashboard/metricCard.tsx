...
export default function MetricCard({
  ...
  const card = (
    <Card
      className={clsx(
        "group relative flex h-full min-h-[250px] flex-col overflow-hidden rounded-3xl border shadow-sm transition duration-200",
        href
    ...
    >
      ...
      <CardContent className="flex flex-1 flex-col pt-0">
        ...
        {href ? (
          <div className="mt-auto inline-flex items-center justify-end gap-1 text-xs font-medium text-muted-foreground transition group-hover:text-slate-950">
  ...
  return (
    <Link
      href={href}
      className="block h-full rounded-3xl outline-none focus-visible:ring-2 focus-visible:ring-slate-900 focus-visible:ring-offset-2"
